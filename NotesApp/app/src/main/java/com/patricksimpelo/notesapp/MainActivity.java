...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notes.clear();
        if (set != null) {
            // Retrieve notes from shared preference
            notes.addAll(set);
        } else {
            // No notes in shared preferences, so make an example note
                ...
                new AlertDialog.Builder(MainActivity.this)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                SharedPreferences sharedPreferences = MainActivity.this.getSharedPreferences("com.patricksimpelo.notesapp", Context.MODE_PRIVATE);
